...
DEFAULT_INPUT = "data/reranker/output/bge_structure_output/rerank_structured_bge_top5.jsonl"
DEFAULT_OUTPUT = "data/generation/output/answers_structure_bge_top5_claude.jsonl"
