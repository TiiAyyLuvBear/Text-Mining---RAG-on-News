...
DEFAULT_INPUT = "..\\output\\rerank_structure_jina_top5.jsonl"
DEFAULT_OUTPUT = "..\\..\\generation\\output\\answers_structure_jina_top5_claude.jsonl"
...
def extract_text(message):
    ...
    # OpenAI-compatible format returned by XAH
