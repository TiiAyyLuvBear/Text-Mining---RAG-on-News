...
DEFAULT_INPUT = "data/reranker/output/jina_token_output/rerank_token_jina_top5.jsonl"
DEFAULT_OUTPUT = "data/generation/output/answers_token_jina_top5_claude.jsonl"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate Jina token rerank answers with Claude via ckey.")
