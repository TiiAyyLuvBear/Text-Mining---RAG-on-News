...
DEFAULT_INPUT = "data/reranker/output/bge_token_output/rerank_token_bge_top5.jsonl"
DEFAULT_OUTPUT = "data/generation/output/answers_token_bge_top5_claude.jsonl"
