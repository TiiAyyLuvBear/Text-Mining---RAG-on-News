...
Usage:
    python src/RAG/evaluate/resume_bge_llm_judge.py --mode both --report
    python src/RAG/evaluate/resume_bge_llm_judge.py --mode token --resume
"""
...
TARGETS = {
    "token": {
        "pred": ROOT / "data/generation/output/answers_token_bge_top5_claude.jsonl",
        "output": ROOT / "data/evaluate/output/bge_token/llm_judge_bge_token_gptscore.jsonl",
        "summary": ROOT / "data/evaluate/output/bge_token/llm_judge_bge_token_summary.json",
        "log": ROOT / "data/evaluate/output/bge_token/run.log",
        "judge": ROOT / "src/RAG/evaluate/jina_token/evaluate_llm_judge_jina_token.py",
        "report": ROOT / "data/evaluate/output/bge_token/resume_report.json",
    },
    "structure": {
        "pred": ROOT / "data/generation/output/answers_structure_bge_top5_claude.jsonl",
        "output": ROOT / "data/evaluate/output/bge_structure/llm_judge_bge_structure_gptscore.jsonl",
        "summary": ROOT / "data/evaluate/output/bge_structure/llm_judge_bge_structure_summary.json",
        "log": ROOT / "data/evaluate/output/bge_structure/run.log",
        "judge": ROOT / "src/RAG/evaluate/jina_structure/evaluation_llm_judge.py",
        "report": ROOT / "data/evaluate/output/bge_structure/resume_report.json",
    },
}
