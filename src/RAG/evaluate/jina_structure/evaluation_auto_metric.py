...
def main():
    ...
    parser.add_argument("--pred", default="data/generation/output/answers_structure_jina_top5_claude.jsonl")
    parser.add_argument("--gold", default="Dataset/QA_Claude/QA_output.jsonl")
    parser.add_argument("--out-dir", default="data/evaluate/output/jina_structure")
