...
def main():
    ...
    parser.add_argument("--pred", default="src/generation/output/answers_structure_bge_top5_claude.jsonl")
    parser.add_argument("--gold", default="Dataset/QA_Claude/QA_output.jsonl")
    parser.add_argument("--out-dir", default="src/evaluate/bge_structure/output")
