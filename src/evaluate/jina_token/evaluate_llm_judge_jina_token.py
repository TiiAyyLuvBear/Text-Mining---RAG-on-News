...
DEFAULT_PRED = "src/generation/output/answers_token_jina_top5_claude.jsonl"
DEFAULT_GOLD = "Dataset/QA_Claude/QA_output.jsonl"
DEFAULT_OUT = "src/evaluate/jina_token/output/llm_judge_jina_token_gptscore.jsonl"
DEFAULT_SUMMARY = "src/evaluate/jina_token/output/llm_judge_jina_token_summary.json"
