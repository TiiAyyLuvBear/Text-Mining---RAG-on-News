...
def main():
    ...
    parser.add_argument("--pred", default="src/generation/output/answers_token_jina_top5_claude.jsonl")
    parser.add_argument("--gold", default="Dataset/QA_Claude/QA_output.jsonl")
    parser.add_argument("--out-dir", default="src/evaluate/jina_token/output")
