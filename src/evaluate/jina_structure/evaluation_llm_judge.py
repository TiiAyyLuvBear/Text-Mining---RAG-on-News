...
DEFAULT_PRED = "src/generation/output/answers_structure_jina_top5_claude.jsonl"
DEFAULT_GOLD = "Dataset/QA_Claude/QA_output.jsonl"
DEFAULT_OUT = "src/generation/output/llm_judge_jina_structure_gptscore.jsonl"
DEFAULT_SUMMARY = "src/generation/output/llm_judge_jina_structure_summary.json"
