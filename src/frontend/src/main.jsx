...
import { compactHistory, compactResult, saveHistory } from "./historyPresentation";
...
function App() {
  ...
  useEffect(() => {
    saveHistory(localStorage, HISTORY_STORAGE_KEY, history);
  }, [history]);
