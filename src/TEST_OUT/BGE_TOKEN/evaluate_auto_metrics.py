...
def main():
    ...
    parser.add_argument("--pred", default="src/LLM_OUTPUT/answers_token_bge_top5_claude.jsonl")
    ...
    write_json(out_dir / "auto_metrics_summary.json", summary)
    write_jsonl(out_dir / "auto_metrics_pairs.jsonl", per_question)
