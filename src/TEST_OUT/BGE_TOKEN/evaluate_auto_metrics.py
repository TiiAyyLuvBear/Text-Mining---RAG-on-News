...
def main():
    ...
    parser.add_argument("--pred", default="src/LLM_OUTPUT/answers_token_bge_claude.jsonl")
    parser.add_argument("--gold", default="Dataset/QA_Claude/QA_output.jsonl")
    parser.add_argument("--out-dir", default="src/TEST_OUT/BGE_TOKEN")
    ...
    write_json(out_dir / "auto_metrics_token_bge_claude_summary.json", summary)
    write_jsonl(out_dir / "auto_metrics_token_bge_claude_pairs.jsonl", per_question)
