...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Qwen generated QA answers with BLEU, ROUGE-L, and BERTScore.")
    parser.add_argument("--pred", default="src/TEST_OUT/QWEN/answers_qwen_colab_full.jsonl")
    parser.add_argument("--gold", default="src/TEST_OUT/QWEN/data_QA_Convert.jsonl")
    parser.add_argument("--out-dir", default="src/TEST_OUT/QWEN")
    ...
    write_json(out_dir / "auto_metrics_qwen_summary.json", summary)
    write_jsonl(out_dir / "auto_metrics_qwen_pairs.jsonl", per_question)
