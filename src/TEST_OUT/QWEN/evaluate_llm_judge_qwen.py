...
DEFAULT_PRED = "src/TEST_OUT/QWEN/answers_qwen_colab_full.jsonl"
DEFAULT_GOLD = "src/TEST_OUT/QWEN/data_QA_Convert.jsonl"
DEFAULT_OUT = "src/TEST_OUT/QWEN/llm_judge_qwen_gptscore.jsonl"
DEFAULT_SUMMARY = "src/TEST_OUT/QWEN/llm_judge_qwen_summary.json"
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Qwen generated answers with LLM-as-a-Judge GPTScore.")
