...
DEFAULT_PRED = "src/LLM_OUTPUT/answers_structure_bge_top5_claude.jsonl"
DEFAULT_GOLD = "Dataset/QA_Claude/QA_output.jsonl"
DEFAULT_OUT = "src/TEST_OUT/llm_judge_structure_bge_top5_claude_gptscore.jsonl"
DEFAULT_SUMMARY = "src/TEST_OUT/llm_judge_structure_bge_top5_claude_summary.json"
