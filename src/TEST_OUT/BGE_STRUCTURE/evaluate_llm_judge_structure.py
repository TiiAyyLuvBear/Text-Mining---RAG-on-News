...
DEFAULT_PRED = "src/LLM_OUTPUT/BGE_STRUCTURE/answers_structure_bge_claude.jsonl"
DEFAULT_GOLD = "Dataset/QA_Claude/QA_output.jsonl"
DEFAULT_OUT = "src/TEST_OUT/BGE_STRUCTURE/llm_judge_structure_bge_claude_gptscore.jsonl"
DEFAULT_SUMMARY = "src/TEST_OUT/BGE_STRUCTURE/llm_judge_structure_bge_claude_summary.json"
