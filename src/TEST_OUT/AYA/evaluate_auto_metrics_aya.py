...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Aya generated QA answers with BLEU, ROUGE-L, and BERTScore.")
    parser.add_argument("--pred", default="src/TEST_OUT/AYA/answers_aya_expanse_8b_colab_full.jsonl")
    parser.add_argument("--gold", default="src/TEST_OUT/AYA/data_QA_Convert.jsonl")
    parser.add_argument("--out-dir", default="src/TEST_OUT/AYA")
    ...
    write_json(out_dir / "auto_metrics_aya_summary.json", summary)
    write_jsonl(out_dir / "auto_metrics_aya_pairs.jsonl", per_question)
