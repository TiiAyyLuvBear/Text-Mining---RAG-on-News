...
DEFAULT_PRED = "src/TEST_OUT/AYA/answers_aya_expanse_8b_colab_full.jsonl"
DEFAULT_GOLD = "src/TEST_OUT/AYA/data_QA_Convert.jsonl"
DEFAULT_OUT = "src/TEST_OUT/AYA/llm_judge_aya_gptscore.jsonl"
DEFAULT_SUMMARY = "src/TEST_OUT/AYA/llm_judge_aya_summary.json"
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Aya generated answers with LLM-as-a-Judge GPTScore.")
