"""Generate BGE-structure RAG answers locally with Meta Llama."""
import argparse
import json
import time
...
DEFAULT_OUTPUT = "src/LLM_OUTPUT/answers_structure_bge_top5_llama.jsonl"
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate structured BGE rerank answers with a local Meta Llama model."
    )
