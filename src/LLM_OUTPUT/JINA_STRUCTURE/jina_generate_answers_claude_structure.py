...
DEFAULT_INPUT = "src/re-ranker/out_reranker/rerank_structure_jina_top5.jsonl"
DEFAULT_OUTPUT = "src/LLM_OUTPUT/JINA_STRUCTURE/answers_structure_jina_top5_claude.jsonl"
