...
Examples (run from the repository root):
    python src/generation/repair_generation_outputs.py --dry-run
    python src/generation/repair_generation_outputs.py
    python src/generation/repair_generation_outputs.py --only token_bge
"""
