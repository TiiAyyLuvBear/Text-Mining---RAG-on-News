...
DEFAULT_INPUT = "src/reranker/output/bge_token_output/rerank_token_bge_top5.jsonl"
DEFAULT_OUTPUT = "src/generation/output/answers_token_bge_top5_claude.jsonl"
